...
const Content = [
  {
    title: 'soundcloud',
    path: 'https://soundcloud.com/eddbeatmusic',
    grayIcon: SoundcloudIconGray,
    whiteIcon: SoundcloudIconWhite,
  },
  {
    title: 'bandcamp',
    path: 'https://eddbeatmusic.bandcamp.com/',
    grayIcon: BandcampIconGray,
    whiteIcon: BandcampIconWhite,
  },
  {
    title: 'instagram',
    path: 'https://www.instagram.com/eddbeatmusic_/',
    grayIcon: InstagramIconGray,
    whiteIcon: InstagramIconWhite,
  },
  {
    title: 'twitter',
    path: 'https://twitter.com/eddbeatmusic',
    grayIcon: TwitterIconGray,
